...
import static com.example.myapplication.utils.ServerInfo.ServerURI_ws;
...
public class ChatActivity_UI extends AppCompatActivity {
    ...
    //初始化用户头像映射
        ...
        //初始化WebSocket客户端
        try {
            URI serverURI = new URI(ServerURI_ws);   //服务器地址
    ...
    private void handleMessage(String message) {
        try {
            ...
            //根据发送者来设置消息类型
            int type = senderUsername.equals(senderUsername) ? Msg.TYPE_SENT : Msg.TYPE_RECEIVED;
