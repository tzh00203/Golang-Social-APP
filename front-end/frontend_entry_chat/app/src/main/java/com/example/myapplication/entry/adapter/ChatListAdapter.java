...
public class ChatListAdapter extends RecyclerView.Adapter<ChatListAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.component_chatlist, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.usernameTextView.setText(chatListItem.getUsername());
        //将聊天对象的用户名显示在列表项中
        holder.chatPartnerTextView.setText(chatListItem.getChatPartner());
        holder.iconImageView.setImageResource(chatListItem.getIconResource());
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView chatPartnerTextView;

        public ViewHolder(@NonNull View itemView) {//构造函数，接收列表项的视图对象
            super(itemView);
            iconImageView = itemView.findViewById(R.id.receiver_icon);  //视图对象找到列表项内的图标和用户名视图
            usernameTextView = itemView.findViewById(R.id.ChatListName);
